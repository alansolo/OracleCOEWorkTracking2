...
namespace OracleCOEWorkTracking.Data.Migrations
{
    ...
    partial class WorkTrackingContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OracleCOEWorkTracking.Data.Entities.Application", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("OracleCOEWorkTracking.Data.Entities.ApplicationModule", b =>
                {
                    b.Property<int>("AppId");

                    b.Property<int>("ModuleId");

                    b.HasKey("AppId", "ModuleId");
            ...
            modelBuilder.Entity("OracleCOEWorkTracking.Data.Entities.ApplicationOwningSite", b =>
                {
                    b.Property<int>("AppId");

                    b.Property<int>("OwningSiteId");

                    b.HasKey("AppId", "OwningSiteId");

                    b.HasIndex("OwningSiteId");

                    b.ToTable("ApplicationOwningSite");
                });

            modelBuilder.Entity("OracleCOEWorkTracking.Data.Entities.ApplicationRegion", b =>
                {
                    b.Property<int>("AppId");

                    b.Property<int>("RegionId");

                    b.HasKey("AppId", "RegionId");

                    b.HasIndex("RegionId");

                    b.ToTable("ApplicationRegion");
                });
            ...
            modelBuilder.Entity("OracleCOEWorkTracking.Data.Entities.EnvironmentSettings", b =>
                {
                    b.Property<int>("Id");

                    b.Property<string>("AddRequestsADGroup");

                    b.Property<string>("EnvironmentName");

                    b.Property<string>("ManageRequestsADGroup");
            ...
            modelBuilder.Entity("OracleCOEWorkTracking.Data.Entities.Request", b =>
                {
                    ...
                    b.Property<bool>("BIImpactedStream");
                    ...
                    b.Property<bool>("OTMImpactedStream");
            ...
            modelBuilder.Entity("OracleCOEWorkTracking.Data.Entities.ApplicationOwningSite", b =>
                {
                    b.HasOne("OracleCOEWorkTracking.Data.Entities.Application", "App")
                        .WithMany()
                        .HasForeignKey("AppId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("OracleCOEWorkTracking.Data.Entities.OwningSite", "OwningSite")
                        .WithMany("AppOwningSites")
            ...
            modelBuilder.Entity("OracleCOEWorkTracking.Data.Entities.Request", b =>
                {
                    b.HasOne("OracleCOEWorkTracking.Data.Entities.Application", "Application")
                        .WithMany()
